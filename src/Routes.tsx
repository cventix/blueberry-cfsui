    ...
    return (
      <Router>
        <Switch>
          ...
          <PrivateRoute isAuthenticated={this.props.isAuth ? true : false} path="/vm/giftcard" component={App} />
          <PrivateRoute isAuthenticated={this.props.isAuth ? true : false} exact path="/vm/order" component={Order} />
